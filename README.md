...
- Three translations supported: Knox Bible (default), Douay-Rheims, and Clementine Vulgate (Latin)
- `/set-translation` slash command to set your preferred translation
- Append `[vul]`, `[dr]`, or `[knox]` to any reference to override your preference inline (e.g. `John 3:16 [vul]`)
